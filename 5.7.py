...
def calculate():
    """
    Arguments:
        price: цена за литр бензина
        distance: расстояние в км
        liter: количества бензина на 100 км
        total_l: в общем сколько потребуется бензина
        total_p: итоговая цена
        
    Returns: итоговая цена, общее количество бензина
    """
    price = 49.5
